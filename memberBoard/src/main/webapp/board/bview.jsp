  ...
  <script type="text/javascript">
     function deleteList(){
    	 if(confirm("정말로 삭제하시겠습니까?")){
    		 alert("삭제페이지로 이동");
    		 location.href="bdelete.do?bid=${bVo.bid}&page=${page}";
    	 }else{
    		 alert("취소");
    		 return false;
    	 }
...
<section>
    ...
    <a href="blist.do?page=${page}&category=${category}&s_word=${s_word}"><div class="list">목록</div></a>
    <a href="#" onclick="deleteList()"><div class="list">삭제</div></a>
    <a href="bmodify.do?bid=${bVo.bid}&page=${page}&category=${category}&s_word=${s_word}"><div class="list">수정</div></a>
    <a href="breply.do?bid=${bVo.bid}&page=${page}&category=${category}&s_word=${s_word}"><div class="list">답변달기</div></a>
  </section>
</body>
</html>